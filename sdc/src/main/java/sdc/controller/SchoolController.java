...
import sdc.convertor.SchoolConvertor;
...
public class SchoolController {
    ...
    public PageResultDTO<SchoolDTO> search(final Pageable pageable) {
    ...
    public ResultDTO<SchoolDTO> get(@PathVariable final Long id) {
