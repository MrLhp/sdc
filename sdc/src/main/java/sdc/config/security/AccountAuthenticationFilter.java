...
import sdc.service.authentication.impl.UserDetailsServiceImpl;
...
public class AccountAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(final HttpServletRequest request, final HttpServletResponse response)
        ...
        // 获取请求数据
        final UserDetailsServiceImpl.UserBean user = (UserDetailsServiceImpl.UserBean)this.userDetailsService
